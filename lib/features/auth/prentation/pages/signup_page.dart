...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> handleSignup() async {
    ...
    final String? session = res.session?.accessToken;
    final String? user = res.user?.id;
    if(session != null && user != null) {
      AppAuthContext.login(session, user);
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("wow good job")));
    }
  }
}
